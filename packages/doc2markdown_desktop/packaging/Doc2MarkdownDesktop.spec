...
icon_path = project_root / "packages" / "doc2markdown_desktop" / "assets" / "anunnaki.ico"
logo_path = project_root / "packages" / "doc2markdown_desktop" / "assets" / "logo.png"
...
a = Analysis(
    [str(project_root / "packages" / "doc2markdown_desktop" / "app.py")],
    pathex=[str(project_root / "packages")],
    binaries=binaries,
    datas=datas,
